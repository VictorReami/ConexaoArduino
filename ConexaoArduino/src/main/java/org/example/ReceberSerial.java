...
public class ReceberSerial  {
    ...
    private String comandoVideoLooping = "C:\\Temp\\VideoLooping.mp4";
    private String comandoVideoAtivar = "C:\\Temp\\VideoAtivar.mp4";
            ...
            try {
                ...
                while(true) {
                    ...
                    if( contadorPortaCOM == 0){
                        ...
                        //Caso a porta COM3 tece aglum problema de conexão, a conexão é fechada e aberta novamente
    ...
    public double verificarMinuto(){
        String videoFilePath = "C:/Temp/VideoAtivar.mp4";
